              ...
              <div class="col-lg-8 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" name="kode" id="kode" class="form-control" 
                   placeholder="Masukan Kode Barang" autofocus autocomplete="off" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="stockminimal" id="stockminimal" class="form-control"
                    placeholder="0" autofocus autocomplete="off" required>
                </div>
              </div>
              <div class="col-lg-4 text-center">
                <img src="<?= $main_url ?>assets/image/barang.png" class="profile-user-img img-circle mb-3" alt="User">
